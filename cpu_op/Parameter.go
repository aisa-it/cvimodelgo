...
func (rcv *Parameter) Attributes(obj *Attribute, j int) bool {
...
func (rcv *Parameter) AttributesLength() int {
	o := flatbuffers.UOffsetT(rcv._tab.Offset(4))
	if o != 0 {
...
func ParameterAddAttributes(builder *flatbuffers.Builder, attributes flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(0, flatbuffers.UOffsetT(attributes), 0)
}
func ParameterStartAttributesVector(builder *flatbuffers.Builder, numElems int) flatbuffers.UOffsetT {
